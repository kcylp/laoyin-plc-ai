...
adopted-by: 老殷工控PLC助手(2026-08-05)——本文件为项目前端治理规范,来源 VoltAgent/awesome-design-md(MIT)
application: 取其工程纪律用于 tia.css 的增量升级:扁平直角(0-4px)、细边框代替阴影、单一蓝色主调、大写微标签、等宽数字;营销版式(display 排印)不适用于工程控制台,不落地
