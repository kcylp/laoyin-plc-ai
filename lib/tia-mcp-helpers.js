...
//  3) 危险工具(下载/删除/强制)必须 confirmed:true,且全部写审计日志
const TIA_MCP_DANGEROUS = /download|delete|remove|force|stop|reset/i;
...
module.exports = { TIA_MCP_DANGEROUS, mcpEnsureAttached, parseBlocksFromTree };
